...
class FairPFNClassifier(TabPFNClassifier):
    def __init__(self):
        ...
        # 1. Force PyTorch to use your CPU instead of the default "cuda:0"
        kwargs['device'] = 'cpu'
        
        # 2. Turn off the GPU-only FP16 acceleration so the CPU doesn't crash
        kwargs['fp16_inference'] = False
